...
def main(
    ...
    **kwargs,
    ...
    model = torch.load(ckpt_path).to(device).eval()
    print("[INFO] LIMIVC is loaded from", ckpt_path)
    ...
    with torch.no_grad():
        ...
        # print("src_feat: ", src_feat.keys())#['x', 'padding_mask', 'features','layer_results']
        ...
        out_mel, attns, _, _ = model(src_feat, tgt_mel)
